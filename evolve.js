...
//abilities, colors, and source files
function choose(abOne, abTwo, colOne, colTwo, srcOne, srcTwo){
...
start.addEventListener("click", function(){
    ...
    anim = setInterval(function(){
        ...
        if (size >= 300) {
            ...
            if (y>=400 && y<=420) {
                if (x>=510 && x<=530) {
                    ...
                    ctx.fillText("with your" + abilities[0],510,500);
                }
            }
            if (y>=420 && y<=440) {
                if (x>=510 && x<=530) {
                    ...
                    ctx.font="15px century gothic";
                    ctx.fillText("You defeated the boss", 510, 480);
                    ctx.fillText("with your" + abilities[1],510,500);
                }
            }
            if (y>=440 && y<=460) {
                if (x>=510 && x<=530) {
                    ...
                    ctx.font="15px century gothic";
                    ctx.fillText("You defeated the boss", 510, 480);
                    ctx.fillText("with your" + abilities[2],510,500);
                }
            }
        }
        ...
        if(size>=256 && size <= 300){
            ...
            ctx.fillText("grow horns or a tail?", 510, 460);
            ctx.fillText("HORNS       TAIL", 510, 490);
